...
if (isset($_POST['enviar'])) {
  if (!empty($_POST['localidad']) || !empty($_POST['tipo'])) {
    ...
    $localidad = buscar($bd, 'estadia', 'localidad', $dato1, $dato2, 'tipo', $tipo1, $tipo2, $tipo3, $tipo4, $tipo5);
    //dd($localidad);
    if (empty($localidad)) {
      //echo "nada";
    }
  ...
  <section class="py-5 bg-info opacity-75 rounded-1">
    <div class="py-lg-5 bg-info ">
      <div class="col-lg-6 col-md-8 mx-auto bg-light border border-light rounded shadow p-3 mb-5 bg-body shadow-lg p-3 mb-5 bg-body rounded">
        <h1 class="fw-light text-center m-5">Estadia</h1>
        <form action="estadia.php" method="POST" class="container row justify-content-around col-md-8 offset-md-2 mx-auto">
          ...
          <div class="col-6">
            ...
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Hostel"> Hostel</label>
            </div>
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Motel"> Motel</label>
            </div>
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Pension"> Pension</label>
            </div>
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Camping"> Camping</label>
            </div>
          </div>
