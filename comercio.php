  ...
  <section class="py-5 bg-info opacity-75 rounded-1">
    <div class="py-lg-5 bg-info ">
      <div class="col-lg-6 col-md-8 mx-auto bg-light border border-light rounded shadow p-3 mb-5 bg-body shadow-lg p-3 mb-5 bg-body rounded">
        <h1 class="fw-light text-center m-5">Comercios y Bancos</h1>
        <form action="comercio.php" method="POST" class="container row justify-content-around col-md-8 offset-md-2 mx-auto">
          ...
          <div class="col-6">
            ...
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Supermercado"> Supermercados</label>
            </div>
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Kiosko"> Kioskos</label>
            </div>
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Banco"> Bancos</label>
            </div>
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Correo"> Correo</label>
            </div>
            <div class="checkbox">
              <label><input type="checkbox" name="tipo[]" value="Farmacia"> Farmacias</label>
            </div>
          </div>
